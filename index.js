...
var produk = (module.exports = {
	...
	handleShowCart: async function(event) {
		...
		let totalHargaOngkir = getOngkir + totalHarga;
		let separator = {
			type: 'separator',
			margin: 'xxl'
		};
		...
		let totalOngkir = {
			...
			contents: [
				...
				{
					type: 'text',
					text: 'Rp.' + totalHargaOngkir.toString(),
					size: 'sm',
					color: '#000000',
					align: 'end'
				}
		...
		echo.contents.body.contents[4].contents.push(totalOngkir);
		return echo;
	},
	...
	handleShowCartAdmin: async function(event) {
		...
		let totalHargaOngkir = totalHarga + listPesanan.data[0].ongkir;
		let separator = {
			type: 'separator',
			margin: 'xxl'
		};
		...
		echo.contents.body.contents[3].contents.push(totalOngkir);
